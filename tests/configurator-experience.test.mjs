...
before(async () => {
  ...
  modules = {
    ...
    vehicleSummary: await server.ssrLoadModule('/src/components/configurator/VehicleConfigurationSummary.jsx'),
    fitmentFeedback: await server.ssrLoadModule('/src/components/configurator/ConfiguratorFitmentFeedback.jsx'),
    summaryPanel: await server.ssrLoadModule('/src/components/configurator/ConfiguratorSummaryPanel.jsx'),
    pricingSummary: await server.ssrLoadModule('/src/components/configurator/ConfiguratorPricingSummary.jsx'),
    commerceActions: await server.ssrLoadModule('/src/components/configurator/ConfiguratorCommerceActions.jsx'),
    experience: await server.ssrLoadModule('/src/components/configurator/ConfiguratorExperience.jsx'),
