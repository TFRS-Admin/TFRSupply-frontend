...
<!-- Local copy of TFRS-Admin/tfrs-engineering-playbook DECISION_ROUTER.md (v3.0.0), part of the Minimum Baseline. Repo-agnostic — do not edit locally; changes belong upstream. -->
...
- **Before any action affecting a shared resource** outside the specific repository (playbook-wide standard changes, changes to a repository's `docs/engineering/` structure or issue Metadata conventions) — always a human checkpoint, never routed to Execute unilaterally.
