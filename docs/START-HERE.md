...
3. Review `docs/architecture/REPO-MAP.md` to understand the repository layout and protected areas.
4. Create or use an issue from `.github/ISSUE_TEMPLATE/agent_task.md` for scoped work.
5. Confirm the working branch is not `production`, `prod`, or `main` before editing.
...
- Identify the responsible agent persona.
